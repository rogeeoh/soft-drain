...
IMG ?= ghcr.io/rogeeoh/soft-drain:latest
...
KIND_CLUSTER ?= soft-drain-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name soft-drain-builder
	$(CONTAINER_TOOL) buildx use soft-drain-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm soft-drain-builder
	rm Dockerfile.cross
